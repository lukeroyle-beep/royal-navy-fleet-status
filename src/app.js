...
function updateSnapshotLabels() {
  ...
  elements.snapshotDescription.title = partial
    ? "Some vessel records and map locations are carried forward from earlier dated reports. This publication does not confirm current positions."
    : "";
  elements.snapshotDescription.textContent = partial
    ? "Partial review · Earlier locations retained"
    : isCurrent
